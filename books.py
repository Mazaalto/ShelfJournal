...
def get_books_as_a_list():
    ...
    sql = "SELECT B.id, B.book_title, B.author_name, B.sent_at, B.visibility FROM books B, users U WHERE B.user_id=U.id AND B.visibility='private' ORDER BY B.book_title"
